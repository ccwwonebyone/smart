...
//自动补全
	var autowork = [
      "师傅到现场查看发现是设备电源故障，现已修复。",
      "师傅联系用户，用户表示宽带已恢复正常，不需师傅上门了。",
      "师傅到现场查看发现是设备断电，重启后故障恢复。",
      "师傅到现场查看发现是设备故障，重新更换后故障恢复。",
      "师傅到现场查看发现是光纤断了，重新熔纤后故障恢复。",
      "我处核实外缆故障，经线路代维处理后，故障恢复。",
      "师傅核实是光衰过大，经线路代维处理后恢复。",
      "我处核实为供电局关电，现已恢复供电，故障恢复。",
      "师傅上门发现电脑设置问题，重新设置后故障恢复。",
      "师傅到现场查看发现是室内线问题，重新连接后，故障恢复。",
      "师傅上门后发现用户家网络是正常的，师傅已向用户解释。",
      "师傅上门后检查发现是用户家路由器问题，师傅重新调试后，故障恢复。",
      "师傅上门后发现用户家网络是正常的，是机顶盒问题，重新调试机顶盒后，故障恢复。",
      "师傅上门检查发现是密码问题，师傅指导用户重置密码后，故障恢复。",
      "师傅到现场查看发现是光衰过大，调试后恢复。",
      "师傅发现是设备端口问题，师傅重新固定端口后，故障恢复。",
      "师傅发现是用户家水晶头问题。更换水晶头后，故障恢复。",
      "师傅到现场查看发现是数据问题，联系网络部重做数据后，故障恢复。",
      "师傅到现场查看发现是设备故障，重新更换后故障恢复。",
      "师傅联系用户时，用户表示现在没有时间，后面有时间会自己联系师傅。",
      "师傅联系用户时，约*号上门",
      "师傅到现场查看发现是室外线问题，重新连接后，故障恢复。",
      "非我处服务范围，我处无法联系解释，请客服转派营销单元联系用户解释。"
    ];
    /*$( "#tdinfo" ).autocomplete({
      source: autowork
    });*/
    $("#tdinfo").typeahead({source:autowork});
});